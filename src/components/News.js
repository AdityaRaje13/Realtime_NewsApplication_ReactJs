    ...
    render() {
        return (
            ...
            <>
                ...
                <div className='display-news' id='display-news'>
                    <h1 align="center" className='my-4' >Today's News - Top {this.props.category} Headlines :</h1>
                    ...
                    <div className="row md-4 container">
                        ...
                        {!this.state.loading && this.state.articles.map((element) => {
                            ...
                            return <div className="col md-4 my-3" >
                                ...
                                <Newsitem bg={this.props.bgBack} title={element.title} description={element.description} imageurl={element.urlToImage} newsurl={element.url} author={element.author} publish={element.publishedAt} source={element.source.name} key={element.id} />
                            </div>
                        })}
